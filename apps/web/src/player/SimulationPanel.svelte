...
{/if}
<style>
  .panel{container:simulation-panel / inline-size;position:relative;width:min(1100px,100%);height:min(860px,calc(100dvh - 36px));display:flex;flex-direction:column;border:1px solid #3b414d;border-radius:12px;background:#12151b;color:#eceef3;box-shadow:0 24px 80px #000b;overflow:hidden}header{display:flex;align-items:center;justify-content:space-between;padding:12px 16px;border-bottom:1px solid #30343d;background:#191c22}header>div:first-child{display:grid;gap:2px}.tools{display:flex;align-items:center;gap:2px}header button{display:grid;place-items:center;padding:7px;border:0;background:transparent;color:#b4bac6;cursor:pointer}header button:hover,header button.active{color:#8fb3ff}main{flex:1;min-height:0;padding:14px;overflow:auto}main.flush{padding:0}.float-tools{position:absolute;top:8px;right:10px;z-index:6;display:flex;gap:2px;padding:2px;border:1px solid #3b414d;border-radius:999px;background:#12151bd9;backdrop-filter:blur(2px)}.float-tools button{display:grid;place-items:center;padding:6px;border:0;border-radius:999px;background:transparent;color:#b4bac6;cursor:pointer}.float-tools button:hover,.float-tools button.active{color:#8fb3ff}.decision-mirror{flex:none;max-height:38dvh;overflow:auto;border-top:1px solid #30343d;background:#0e1116}@media(max-width:700px){.panel{width:100%;height:100dvh;border:0;border-radius:0}main{padding:10px}}
