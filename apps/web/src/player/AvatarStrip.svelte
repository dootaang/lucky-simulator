<script lang="ts">
  ...
  let {cards,activeId,avatarFor:_,onadd,onselect,onremove,onsettings}:{cards:Array<CardLibraryMeta&{ephemeral?:boolean}>;activeId:string|null;avatarFor?:(id:string)=>string|null;onadd:()=>void;onselect:(id:string)=>void;onremove:(id:string)=>void;onsettings:()=>void}=$props();
</script>
