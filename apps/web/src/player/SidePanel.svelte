<script lang="ts">
  ...
  let { profile, passport, index, session, version, bindingUi, assets, assetUrlFor, open = false, oncreate, onselect, onrename, onremove, onexport, onimport, oninspect, onundo, onredo }: {
    ...
    onexport: () => void; onimport: (file: File) => void; oninspect: () => void; onundo: () => void; onredo: () => void;
  } = $props();
