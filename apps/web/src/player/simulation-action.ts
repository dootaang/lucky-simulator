...
export type SimulationActionPhase='session-start'|'checkpoint-complete'|'engine-complete'|'memory-complete'|'prompt-complete'|'provider-complete'|'receipt-complete'|'action-durable'|'save-start'|'save-complete';
