...
export type SimulationActionMode=Extract<SessionActionMode,'narrated'|'ledger'|'scene'>;
export type SimulationActionPhase=SessionActionPhase;
export type SimulationActionTrace=SessionActionTrace;
export type SimulationActionRequest=Omit<SessionActionRequest,'mode'>&{mode:SimulationActionMode};
