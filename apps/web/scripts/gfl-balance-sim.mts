...
function play(slots:string[],ratio:number,seed:number,stars:number,single=false){
...
const compositionPassed=proper>=55&&proper<=85&&proper-reverse>=5&&proper-reverse<=20&&low<30;
