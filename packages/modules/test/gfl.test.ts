...
const schema={
  ...
  gfl:{dolls:[{id:'m4a1',name:'M4A1',class:'AR',grade:5,maxHp:1000,power:1000,maxMp:1600,mood:90},{id:'ump45',name:'UMP45',class:'SMG',grade:4,maxHp:900,power:900}],items:[{id:'ration',name:'전투식량',price:50}],equipment:[{id:'scope',name:'옵티컬',price:100,power:50,ban:['SG']}],fairies:[{id:'command',name:'지휘요정',power:300}],missions:[{id:'alpha',name:'ALPHA',power:800,enemy:'철혈',rank:'E',rewards:{gold:500,parts:1}}],facilities:[{id:'base1',maxLevel:5,cost:{gold:100,res:50}}],modPower:[111,222,333],commanderFunds:10000,manufacturing:{doll:{gold:100,res:100},equipment:{gold:100,res:100},heavy:{gold:500,res:500}}}
};
