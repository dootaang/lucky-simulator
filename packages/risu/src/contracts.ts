...
export interface PromptPreset{contract:'prompt-preset/0.1';id:string;name:string;compatibilityMode:'risu'|'simpack';version:number;blocks:PromptBlock[];settings:{assistantPrefill:string;sendNames:boolean;sendChatAsSystem:boolean};toggles?:PresetToggle[];raw:unknown|null}
