...
test('default engine gives extracted features to their modules and leaves the rest in legacy', () => {
  ...
  assert.deepEqual(registry.listModules().map((module) => module.id), ['core.stats', 'core.inventory', 'core.progression', 'core.equipment', 'rpg.quests', 'rpg.party', 'core.time', 'core.location', 'rpg.loot', 'rpg.shop', 'rpg.crafting', 'core.factions', 'core.jobs', 'genre.hunter', 'combat.turnbased', 'legacy.monolith']);
